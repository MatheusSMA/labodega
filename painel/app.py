...
<style>
  ...
  @media(hover:hover) and (pointer:fine){
    .item.com-video:hover .video-wrap{max-height:450px;opacity:1;margin-top:14px}
  }
  ...
  .item.com-video.aberto .video-wrap{max-height:450px;opacity:1;margin-top:14px}
  .item.com-video.aberto .video-wrap .dica{display:block}
  .video-wrap video{width:auto;max-width:100%;height:400px;object-fit:contain;display:block;
