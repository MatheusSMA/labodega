...
<style>
  ...
  @media(hover:hover) and (pointer:fine){
    .item.com-video:hover .video-wrap{max-height:620px;opacity:1;margin-top:14px}
  }
  ...
  .item.com-video.aberto .video-wrap{max-height:620px;opacity:1;margin-top:14px}
  .item.com-video.aberto .video-wrap .dica{display:block}
  .video-wrap video{width:min(80%,320px);height:auto;object-fit:contain;display:block;
